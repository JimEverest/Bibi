...
# 识别引擎：sensevoice（中英混说更好，自带标点）或 paraformer（中文为主，支持热词）
ASR_ENGINE = os.environ.get("ASR_ENGINE", "sensevoice").lower()

# SenseVoice 模型名（modelscope id，也用作本地缓存目录名）
SENSEVOICE_MODEL_NAME = os.environ.get(
